...
<html>
  <body>
    ...
    print("<TABLE width=\"100%\" bgcolor=\"#CCCCFF\"><TR><TD><FONT size=\"4\" color=\"#000000\"><center><B><a href=\"ViewComment.php?comment_table=$comment_table&storyId=".$row["story_id"]."&commentId=".$row["id"]."\">".$row["subject"]."</a></B>&nbsp</FONT> (Score:".$row["rating"].")</center></TABLE>\n");
