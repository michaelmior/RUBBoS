...
#     print $8 > FILENAME".net.rxcmp.dat"; # Number of compressed packets received per second (for cslip etc.).
#     print $9 > FILENAME".net.txcmp.dat"; # Number of compressed packets transmitted per second.
#     print $10 > FILENAME".net.rxmcst.dat"; # Number of multicast packets received per second.
    }
...
#	  print $6 > FILENAME".mem.kbmemshrd.dat"; # Amount of memory shared by the system in kilobytes.  Always zero with 2.4 kernels.
...
#	  print $5 > FILENAME".sock.udpsck.dat"; # Number of UDP sockets currently in use.
#	  print $6 > FILENAME".sock.rawsck.dat"; # Number of RAW sockets currently in use.
#	  print $7 > FILENAME".sock.ip-frag.dat"; # Number of IP fragments currently in use.
	  n = "";
 	}
    }
}
